...
- **Week 7- Writting Essay and  [AdaGMLP: AdaBoosting GNN-to-MLP Knowledge Distillation][GRAPH-LESS NEURAL NETWORKS: TEACHING OLD  MLPS NEW TRICKS VIA DISTILLATION](https://github.com/fal1winter/graph-notebook)**
---
